        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2> List Poli </h2><br>
                        <a href="<?php echo site_url('Superadmin/Poli/Tambah_poli');?>">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <a href="<?php echo site_url('Superadmin/Poli/Edit_poli/'.$p['id_poli']);?>">
                                            
                                            <button type="button" class="btn btn-raised btn-info waves-effect"><i class="fa fa-pencil" style="color: black;"></i></button>
                                        </a>
                                    </td>
                                    <td style="text-align: center;">
                                        <a data-toggle="modal" data-target="#ModalHapus<?php echo $p['id_poli'];?>">
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="false">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo site_url('Superadmin/Poli/Delete_poli');?>" method="POST">
                        <div class="modal-body">
                            <input type="hidden" name="id_poli" value="<?php echo $id;?>"/>
                            <input type="hidden" name="nama" value="<?php echo $nama;?>"/>
                            <p>Apakah kamu yakin mau menghapus <b> poli <?php echo $nama; ?></b> dari daftar?</p>
                        </div>
