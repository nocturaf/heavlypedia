				...
				<div class="card">
                    ...
                    <?php 
                      foreach($data_akun as $p) :
                        ...
                        $no_telp = $p['no_telp'];
                    ?>
                    <form method="POST" action="<?php echo site_url('Admin/Setting/Edit_profil')?>" onsubmit="return Validate_edit('<?php echo $id ?>')" id="editForm<?php echo $id ?>" enctype="multipart/form-data">
