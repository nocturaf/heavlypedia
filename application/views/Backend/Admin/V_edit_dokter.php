                ...
                <div class="card">
                    ...
                    <?php 
                      foreach($data_dokter as $p) :
                        ...
                        $no_telp = $p['no_telp'];
                    ?>
                    <form method="POST" action="<?php echo site_url('Admin/Dokter/Edit_data_dokter')?>" onsubmit="return Validate_edit('<?php echo $id ?>')" id="editForm<?php echo $id ?>">
                        <input type="hidden" name="id_dokter" class="form-control" value="<?php echo $id;?>">
                        <div class="row clearfix">
                            <div class="col-sm-12">
