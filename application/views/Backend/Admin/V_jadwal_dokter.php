    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2> Daftar Jadwal Dokter di <?php echo $nama_admin; ?> </h2> <br>
                        <a href="<?php echo site_url('Admin/Dokter/Tambah_jadwal_dokter');?>">
                            <button type="button" class="btn btn-raised btn-info waves-effect"><i class="zmdi zmdi-calendar-note" style="color: black;"></i> Tambah Jadwal Dokter</button>
                        </a>
                    </div>
                    <div class="body">
                          ...
                          <table class="table table-striped">
                            <thead>
                              <tr>
                                ...
                                <th style="text-align: center;">Hari Praktek</th>
                                <th style="text-align: center;">Muali Praktek</th>
                                <th style="text-align: center;">Selesai Praktek</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center; padding-top: 2em;"><?php echo $hari_praktek; ?></td>
                                    <td style="text-align: center; padding-top: 2em;"><?php echo $mulai_praktek; ?></td>
                                    <td style="text-align: center; padding-top: 2em;"><?php echo $selesai_praktek; ?></td>
                                    <td style="text-align: center; padding-top: 2em;"><?php echo $kuota; ?></td>
                                    <td style="text-align: center;">
                                        <a href="<?php echo site_url('Admin/Dokter/Edit_jadwal_dokter/'.$p['id_jadwal']);?>">
                                            
                                            <button type="button" class="btn btn-raised btn-info waves-effect"><i class="fa fa-pencil" style="color: black;"></i></button>
                                        </a>
                                    </td>
                                    <td style="text-align: center;">
                                        <a data-toggle="modal" data-target="#ModalHapus<?php echo $p['id_jadwal'];?>">
        ...
        <!-- Modal Delete Dokter -->
        <?php 
        foreach($data_jadwal_dokter as $k) :
            $id     = $k['id_jadwal'];
            $nama   = $k['nama_dokter'];
        ?>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel">Hapus Jadwal Dokter</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo site_url('Admin/Dokter/Delete_jadwal_dokter');?>" method="POST">
                        <div class="modal-body">
                            <input type="hidden" name="id_jadwal" value="<?php echo $id;?>"/>
                            <p>Apakah kamu yakin mau menghapus jadwal <b>dr. <?php echo $nama; ?></b> dari daftar?</p>
                        </div>
